...
| chilipeppr.load() URL | http://raw.githubusercontent.com/Reggino/draadbuiger-workspace/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/undefined/undefined |
| Github URL            | http://github.com/Reggino/draadbuiger-workspace |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/Reggino/draadbuiger-workspace/master/auto-generated-workspace.html",
  function() {
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-sample"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Sample"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace sample."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/Reggino/draadbuiger-workspace/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/undefined/undefined"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/Reggino/draadbuiger-workspace"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://undefined-undefined.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
our pubsubviewer widget that makes those links for us.</td></tr><tr valign="top"><td>load3dViewerWidget</td><td>function</td><td>function (callback) </td></tr>
      </tbody>
  </table>
